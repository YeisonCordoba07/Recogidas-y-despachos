      ...
      <header className='border-b-1 relative z-20 w-full border-b border-slate-200 bg-white/90 shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden'>
        <div className='relative w-full px-10'>
          ...
          >
            ...
            >
              <NavbarLink href='/lotes' titulo='Lotes' />
              <NavbarLink href='/recogidas' titulo='Recogidas' />
              <NavbarLink href='/envios' titulo='Envios' />
              <NavbarLink href='/usuarios' titulo='Usuarios' />
            </ul>
...
const NavbarLink = ({ href, titulo }: EntradasNavbarLink) => {
  ...
  return (
    <li role='none' className='flex items-stretch'>
      <Link
        ...
        className={
          router.asPath === href
            ? 'flex items-center gap-2 py-4 text-blue-500 transition-colors duration-300 hover:text-blue-600 focus:text-blue-600 focus:outline-none focus-visible:outline-none lg:px-8'
            : 'flex items-center gap-2 py-4 transition-colors duration-300 hover:text-blue-500 focus:text-blue-600 focus:outline-none focus-visible:outline-none lg:px-8'
        }
        href={href}
      >
        <span>{titulo}</span>
